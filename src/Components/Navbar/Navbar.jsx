...
<nav className="border-gray-200 bg-[#2c3e50] fixed top-0 z-40  w-full p-4 ">
  <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    ...
    <Link to='' className={last == null? "self-center font-semibold whitespace-nowrap text-3xl  text-white":"self-center font-semibold whitespace-nowrap text-3xl  text-white"} onClick={()=> active(null)}>START FRAMEWORK</Link>
    </a>
